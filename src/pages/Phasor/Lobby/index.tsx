...
const loreText = `You are now standing at the feet of an ancient Koder from a distant era. Legends whisper that he crafted a Code Editor so powerful that it allows him to manipulate the very fabric of reality. It taps into the fundamental coding principles that exist in every era, making it the key to unlocking the mysteries of each puzzle. Now, the weapon has been passed on to you, and with it comes the heavy responsibility. 
